...
echo --server 195.148.127.230 --port $port --width $width --fps $fps --name sender --autocall true --force_fieldtrials=WebRTC-FlexFEC-03-Advertised/Enabled/WebRTC-FlexFEC-03/Enabled/ 2> /tmp/test_sender.log

gdb ~/Workspace/Pandia/bin/peerconnection_client_headless
