...
LONGOPTS=duration,port,id,width
OPTIONS=d:p:i:w:
...
tmux send-key -t $session:0 "cd ~/Workspace/Pandia; python -m pandia.fakewebcam.main -w ${width} > ~/Workspace/Pandia/results/fakewebcam.log" Enter
