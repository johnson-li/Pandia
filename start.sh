...
# Sync time
python -m pandia.ntp.ntpclient > /tmp/test_sender.log
...
~/Workspace/Pandia/scripts/start_traffic_control_remote.sh -p $port -b 1000000 -d 5 -l 2
